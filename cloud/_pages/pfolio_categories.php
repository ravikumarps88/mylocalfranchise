...
//---------------------------------------------------------------------------------------------------
if ($action=="delete") {
	dbQuery("UPDATE portfolio_categ SET status='deleted' WHERE id='{$_REQUEST['id']}'");
...
$query = "select * from portfolio_categ WHERE $status ORDER BY $sort";
...
<script>
	$(document).ready(function(){
		...
		$('#status').change(function()	{
			$(location).attr('href','index.php?_page=pfolio_categories&status='+$(this).val());
		});
	});
</script>
<? ############################################################################################## ?>
Show:&nbsp;<select id="status" style="float:right; width:200px;">
        ...
        &nbsp;&nbsp;&nbsp;
        <a href="index.php?_page=add_edit_pfolio_categories" class="button"  style="float:right;margin-top: -33px;">New Category&nbsp;<img src="images/icons/add.png" title="New Category" alt="New Category"  /></a>
<div class="grid_12">
    <div class="box">
        <div class="header">
...
<? } else { ?>
  <tr >
    ...
    <td width="23%" align="left"><a href="index.php?_page=pfolio_categories">Category</a></td>
...
<? for ($i=0; $i<count($recordsList); $i++) {?>
			<tr style="<?=$i%2==0 ? 'background-color:#FFF;' : 'background-color:#F4F4F8;';?>">
              ...
              <td width="23%" align="left"><?=$recordsList[$i]['category']?></a></td>
              ...
              <a href="index.php?_page=add_edit_pfolio_categories&action=edit&id=<?=$recordsList[$i]['id']?>"><img src="images/icons/edit.png" title="Edit" alt="Edit" /></a>&nbsp;&nbsp;
              
			  <a href="index.php?_page=pfolio_categories&action=delete&id=<?=$recordsList[$i]['id']?>"><img src="images/icons/delete.png"  onclick="return confirm ('Are you sure?');" title="Delete" alt="Delete" /></a></td>
  </tr>
<? } ?>
</tbody>
</table>  
