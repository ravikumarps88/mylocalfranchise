...
$lifestyleUrlArray	= dbQuery("SELECT url_title FROM franchise_lifestyle WHERE status='active'");
$customLifestyleUrls = array();
foreach($lifestyleUrlArray as $lifestyleVal)
{
    $customLifestyleUrls[] = $lifestyleVal['url_title'];
}
