...
class imageTransform
{
    ...
    function output_target_image_raw($targetImageIdentifier)
    {
            
                return imagejpeg($targetImageIdentifier, "", $this->jpegOutputQuality);
    }
    ...
    function resize($raw=false)
    {
        ...
        if (is_array($result)) {
            ...
            // writes image
            return (!$raw) ? $this->output_target_image($targetImageIdentifier) : $this->output_target_image_raw($targetImageIdentifier);
